...
describe('namespace exception tests', function () {
    ...
    it('should throw illegal path exception', function () {
        ...
        }).toThrow(exception_1.IllegalPathException);
    });
});
describe('warehouse basic tests', function () {
    let warehouse = new warehouse_1.Warehouse()
        ...
        .set('maxConnection', 100);
    it('should be true', function () {
        expect(warehouse.get('isDebug')).toEqual(true);
    });
    warehouse = new warehouse_1.Warehouse({
...
describe('registry basic tests', function () {
    const warehouse = new warehouse_1.Warehouse();
    const myNamespace = warehouse.createNamespace('myNamespace');
    const registry = new registry_1.Registry(warehouse.getNamespace());
    ...
    it('should throw path not allowed exception', function () {
        ...
        }).toThrow(exception_1.PathNotAllowedException);
    });
    it('should throw path excepted exception', function () {
        ...
        }).toThrow(exception_1.PathExceptedException);
    });
